                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                                                   ...
                                                   <div class="card-header">
                                                       ...
                                                       <form  action="lotto_rejected_list.php" class="form-horizontal" method="post" enctype="multipart/form-data" name="register_credit">
                            ...
                            <div class="card-body">
                                 <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                     ...
                                     <tfoot>
                                        ...
                                        <?php
                                        $i = 1;
                                        while ($row = mysqli_fetch_assoc($result_rejected_num)) {
