                    ...
                    <figure class="hover-box hover-box-01">
                        ...
                        <div class="overlay flex-bl typo-light" data-linear-gradient="rgba(31,34,41,0.5)|rgba(31,34,41,1)">
                            <div class="info-text text-center">
                                <a href="watch.php?v_id=<?php echo $vid ?>" data-poptrox="youtube,800x400" class=" button button-icon radius-full margin-lr-5 color-button-default solid"><i class="icon-video"></i></a>
                                <a href="#" class="button button-icon radius-full margin-lr-5 color-button-default solid"><i class="icon-profile-male"></i></a>
                                <h3 class="heading-content tiny bold-600 margin-b-5 margin-t-30"><a href="watch.php?v_id=<?php echo $row['v_id']; ?>"><?php echo $row['v_title']; ?></a></h3>
